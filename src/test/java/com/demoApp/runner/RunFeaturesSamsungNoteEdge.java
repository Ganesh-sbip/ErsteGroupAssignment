...
public class RunFeaturesSamsungNoteEdge extends BaseTest {
    ...
    @Test(groups = "cucumber", description = "Appium Demo for Erste Group(Assignment)", dataProvider = "scenarios")
