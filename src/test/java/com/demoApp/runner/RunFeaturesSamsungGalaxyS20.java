...
public class RunFeaturesSamsungGalaxyS20 extends BaseTest {
    ...
    @Test(groups = "cucumber", description = "Demo for Mobile Automation(Erste Group)", dataProvider = "scenarios")
